...
public class ByCountryItemsInnerCountriesInner {
  ...
  **/
   ...
   * @return the ByCountryItemsInnerCountriesInner instance itself
   */
  public ByCountryItemsInnerCountriesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.country, byCountryItemsInnerCountriesInner.country) &&
        ...
        Objects.equals(this.additionalProperties, byCountryItemsInnerCountriesInner.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(country, rank, views, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ByCountryItemsInnerCountriesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ByCountryItemsInnerCountriesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ByCountryItemsInnerCountriesInner>() {
           ...
           public ByCountryItemsInnerCountriesInner read(JsonReader in) throws IOException {
             ...
             ByCountryItemsInnerCountriesInner instance = thisAdapter.fromJsonTree(jsonObj);
