...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://wikimedia.org/api/rest_v1";
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        authentications.put("mediawiki_auth", new ApiKeyAuth("header", "cookie"));
        ...
        if (configuration != null) {
            if (configuration.mediawikiAuth != null) {
                this.setMediawikiAuth(configuration.mediawikiAuth);
            }
            setVerifyingSsl(configuration.verifyingSsl);
        }
    }

    public String getMediawikiAuth() {
        return ((ApiKeyAuth) this.getAuthentication("mediawiki_auth")).getApiKey();
    }

    public void setMediawikiAuth(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("mediawiki_auth")).setApiKey(apiKey);
    }

    public void setMediawikiAuthPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("mediawiki_auth")).setApiKeyPrefix(prefix);
    }
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://wikimedia.org/api/rest_v1)
