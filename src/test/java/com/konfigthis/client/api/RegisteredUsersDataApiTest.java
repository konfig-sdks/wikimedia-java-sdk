...
public class RegisteredUsersDataApiTest {
    ...
    private static RegisteredUsersDataApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new RegisteredUsersDataApi(apiClient);
    }
     ...
     */
    @Test
    public void getNewUserCountsByProjectAndDateRangeTest() throws ApiException {
        String project = null;
        String granularity = null;
        String start = null;
        String end = null;
        Object response = api.getNewUserCountsByProjectAndDateRange(project, granularity, start, end)
                .execute();
