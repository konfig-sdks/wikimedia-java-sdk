...
public class EditsDataApiTest {
    ...
    private static EditsDataApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new EditsDataApi(apiClient);
    }
     ...
     */
    @Test
    public void getEditsCountsForProjectTest() throws ApiException {
        String project = null;
        ...
        String start = null;
        String end = null;
        Object response = api.getEditsCountsForProject(project, editorType, pageType, granularity, start, end)
                .execute();
     ...
     */
    @Test
    public void getPageEditCountsTest() throws ApiException {
        String project = null;
        ...
        String start = null;
        String end = null;
        Object response = api.getPageEditCounts(project, pageTitle, editorType, granularity, start, end)
                .execute();
        // TODO: test validations
    }
