...
/**
 * API tests for UniqueDevicesDataApi
 */
@Disabled
public class UniqueDevicesDataApiTest {

    private static UniqueDevicesDataApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new UniqueDevicesDataApi(apiClient);
    }
     ...
     */
    @Test
    public void getByProjectAndDateRangeTest() throws ApiException {
        String project = null;
        String accessSite = null;
        String granularity = null;
        String start = null;
        String end = null;
        Object response = api.getByProjectAndDateRange(project, accessSite, granularity, start, end)
                .execute();
