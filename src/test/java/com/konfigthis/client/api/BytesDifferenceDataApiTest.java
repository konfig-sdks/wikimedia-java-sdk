...
public class BytesDifferenceDataApiTest {
    ...
    private static BytesDifferenceDataApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new BytesDifferenceDataApi(apiClient);
    }
     ...
     */
    @Test
    public void getAbsoluteAggregateByProjectAndDateRangeTest() throws ApiException {
        String project = null;
        ...
        String start = null;
        String end = null;
        Object response = api.getAbsoluteAggregateByProjectAndDateRange(project, editorType, pageType, granularity, start, end)
                .execute();
     ...
     */
    @Test
    public void getAbsolutePerPageTest() throws ApiException {
        String project = null;
        ...
        String start = null;
        String end = null;
        Object response = api.getAbsolutePerPage(project, pageTitle, editorType, granularity, start, end)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getNetAggregateByProjectAndDateRangeTest() throws ApiException {
        String project = null;
        String editorType = null;
        String pageType = null;
        String granularity = null;
        String start = null;
        String end = null;
        Object response = api.getNetAggregateByProjectAndDateRange(project, editorType, pageType, granularity, start, end)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getSumNetTextBytesDifferencePerPageTest() throws ApiException {
        String project = null;
        String pageTitle = null;
        String editorType = null;
        String granularity = null;
        String start = null;
        String end = null;
        Object response = api.getSumNetTextBytesDifferencePerPage(project, pageTitle, editorType, granularity, start, end)
                .execute();
        // TODO: test validations
    }
